// Vim logo, from Wikimedia Commons (GPL v2+): https://commons.wikimedia.org/wiki/File:Vimlogo.svg
...
@customElement('vim-logo-icon')
export class VimLogoIcon extends LightLitElement {
